...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (!avatar) throw new ApiError(400, "Error on uploading avatar image in cloudinary");
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  if (!validPassword) throw new ApiError("Please enter valid credentials");
...
const updateAvatar = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, "Avatar Image changed successfully"));
});
